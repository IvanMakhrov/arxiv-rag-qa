...
with DAG(
    ...
    trigger_downloader = TriggerDagRunOperator(
        task_id="trigger_data_downloader",
        trigger_dag_id="data_downloader",
    ...
    trigger_downloader >> trigger_building_rag >> trigger_evaluation
